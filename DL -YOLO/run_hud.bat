...
:: Check for model
if not exist "models\champion_model.pt" (
    echo [ERROR] YOLOv8 model not found.
    echo Expected path: models\champion_model.pt
...
if %errorlevel% neq 0 (
    ...
    echo 2. Missing dependencies (Run: pip install opencv-python ultralytics torch numpy).
